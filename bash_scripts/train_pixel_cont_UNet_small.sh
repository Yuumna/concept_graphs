...
#SBATCH --job-name UNet_w/o_tok_cont_small           # short: -J <job name>
...
# Running the job
start=`date +%s`
python train_merge.py --run_desc fourth_run --our_labels False  --model U-Net  --batch_size 64 --n_epoch 100 --log_freq 1
end=`date +%s`
runtime=$((end-start))
