...
#SBATCH --job-name UNet_w_token_discrete           # short: -J <job name>
...
# Running the job
start=`date +%s`
python train_merge.py --run_desc first_run  --our_labels True  --model U-Net  --batch_size 256 --n_epoch 6000 --token_folder /work/dlclarge2/aliy-maskgit/maskgit/image_tokenization/vqgan_logs/2025-02-13T13-25-14_codebook_Third_synthetic_DLC13913381
end=`date +%s`
runtime=$((end-start))
