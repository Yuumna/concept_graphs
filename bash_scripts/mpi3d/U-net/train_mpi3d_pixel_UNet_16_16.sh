...
#SBATCH --job-name mpi3d_U-Net_pixel           # short: -J <job name>
...
# Running the job
start=`date +%s`
python train_merge_mpi3d.py --pixel_size 64 --model U-Net --run_desc first_run_32_B --batch_size 32 --n_sample 32 --log_freq 1
end=`date +%s`
runtime=$((end-start))
