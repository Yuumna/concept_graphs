...
#SBATCH --job-name celeb_UNet_w/o_tok           # short: -J <job name>
...
# Running the job
start=`date +%s`
python train_merge.py --dataset celeba-3classes-smiling-10000_100 --run_desc pixel_48 --pixel_size 48  --our_labels False  --model U-Net  --batch_size 64 --n_epoch 6000
end=`date +%s`
runtime=$((end-start))
