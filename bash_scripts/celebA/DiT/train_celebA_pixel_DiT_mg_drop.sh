...
#SBATCH --job-name celeb_DiT_mg_w/o_token_drop          # short: -J <job name>
...
# Running the job
start=`date +%s`
python train_merge_celebA.py --dataset celeba-3classes-smiling-10000_100 --run_desc DiT_mg_dropout --dropout 0.1 --pixel_size 48 --our_labels True  --model DiT  --batch_size 64 --n_epoch 6000
end=`date +%s`
runtime=$((end-start))
