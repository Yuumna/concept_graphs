...
# Running the job
start=`date +%s`
python train_merge_celebA.py --dataset celeba-3classes-smiling-10000_100 --run_desc DiT_B --pixel_size 48 --our_labels True  --model DiT  --batch_size 64 --n_epoch 6000
end=`date +%s`
runtime=$((end-start))
