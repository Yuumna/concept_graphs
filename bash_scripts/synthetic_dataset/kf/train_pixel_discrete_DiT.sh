...
#SBATCH --job-name DiT_w/o_token_discrete           # short: -J <job name>
...
python train_merge.py --run_desc XAI --pixel_size 28 --our_labels True  --model DiT  --dropout 0.0 --batch_size 256 --n_epoch 6000 
end=`date +%s`
runtime=$((end-start))
