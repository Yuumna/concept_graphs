...
#SBATCH --job-name DiT_w_token_discrete_drop          # short: -J <job name>
...
python train_merge.py --run_desc XAI_dropout  --pixel_size 28 --our_labels True  --model DiT  --dropout 0.1 --batch_size 256 --n_epoch 6000 --token_folder /work/dlclarge2/aliy-maskgit/maskgit/image_tokenization/vqgan_logs/2025-02-13T13-25-14_codebook_Third_synthetic_DLC13913381
end=`date +%s`
runtime=$((end-start))
