...
#SBATCH --job-name DiT_w/o_token_cont_drop_0.01           # short: -J <job name>
...
python train_merge.py --run_desc XAI_dropout  --pixel_size 28 --our_labels False  --model DiT  --dropout 0.01 --batch_size 256 --n_epoch 6000 
end=`date +%s`
runtime=$((end-start))
