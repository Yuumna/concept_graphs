...
#SBATCH --job-name UNet_w/o_token_discrete           # short: -J <job name>
...
# Running the job
start=`date +%s`
python train_merge.py --run_desc first_run --our_labels True  --model U-Net  --batch_size 256 --n_epoch 6000
end=`date +%s`
runtime=$((end-start))
